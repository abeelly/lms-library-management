                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="assets/images/author/avatar4.jpg" alt="avatar">
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown"><?php
        $a=intval($_SESSION['key']);
        $query="SELECT student_middlename from `student_table` where student_rollno=$a";
        $result = mysqli_query($conn,$query);
        $row=mysqli_fetch_assoc($result);
        echo "Hi ",$row['student_middlename'],"!!!";?> <i class="fa fa-angle-down"></i></h4>
